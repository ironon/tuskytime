...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { get props() {
      ...
      minimized = v;
    }, minimize, addQuestion };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[--><head data-v-f930553c><link rel="stylesheet" href="/assets/style.css" data-v-f930553c></head><div id="default-layout" data-v-f930553c>`);
  if ($setup.props.minimizable) {
    _push(`<button id="minimizebutton" data-v-f930553c>v</button>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div id="navbox" style="${ssrRenderStyle($setup.minimized)}" data-v-f930553c><a class="nav-link" href="/study" data-v-f930553c>Study</a><img src="/assets/tuskylogo.png" data-v-f930553c><h1 id="nav-title" data-v-f930553c>TUSKY TIME</h1><a class="nav-link" href="/" data-v-f930553c>Home</a></div><div id="app" data-v-f930553c>`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</div><div id="footer" data-v-f930553c><p data-v-f930553c>not affiliated with LCPS or Tuscarora but that&#39;d be pretty cool if I was </p><p data-v-f930553c>Made by David Macpherson, 875497@lcps.org</p><a href="/coolpeople" data-v-f930553c>cool people list</a></div></div><!--]-->`);
}
...
const DefaultLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-f930553c"]]);
