...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  return renderTemplate`${renderComponent($$result, "NormalLayout", null, { "client:only": "vue", "client:component-hydration": "only", "client:component-path": "C:/Users/david/Programming/tuskytime/src/layouts/default.vue", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate`  
...
const $$Coolpeople = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "DefaultLayout", null, { "client:only": "vue", "client:component-hydration": "only", "class": "astro-DKUQK47Z", "client:component-path": "C:/Users/david/Programming/tuskytime/src/layouts/default.vue", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate`
