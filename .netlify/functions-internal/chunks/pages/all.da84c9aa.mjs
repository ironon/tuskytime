...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<!--[--><head data-v-3715e2f3><link rel="stylesheet" href="/assets/style.css" data-v-3715e2f3></head><div id="default-layout" data-v-3715e2f3>`);
  if ($setup.props.minimizable) {
    _push(`<button id="minimizebutton" data-v-3715e2f3>v</button>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div id="navbox" style="${ssrRenderStyle($setup.minimized)}" data-v-3715e2f3><a class="nav-link" href="/study" data-v-3715e2f3>Study</a><img src="/assets/tuskylogo.png" data-v-3715e2f3><h1 id="nav-title" data-v-3715e2f3>TUSKY TIME</h1><a class="nav-link" href="/" data-v-3715e2f3>Home</a></div><div id="app" data-v-3715e2f3>`);
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(`</div><div id="footer" data-v-3715e2f3><p data-v-3715e2f3>not affiliated with LCPS or Tuscarora but that&#39;d be pretty cool if I was </p><p data-v-3715e2f3>Made by David Macpherson, 875497@lcps.org</p><a href="/coolpeople" data-v-3715e2f3>cool people list</a></div></div><!--]-->`);
}
...
const DefaultLayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-3715e2f3"]]);
